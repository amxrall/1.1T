...
void ItemConvert(int ObjectItem, BYTE Attribute1, BYTE Attribute2, BYTE Attribute3)
{
	*(DWORD*)(ObjectItem + 4) = Attribute1;
	...
	if ((*(WORD*)ObjectItem >= ITEMGET(12, 3) && *(WORD*)ObjectItem <= ITEMGET(12, 6))
		|| *(WORD*)ObjectItem == ITEMGET(0, 19)
		|| *(WORD*)ObjectItem == ITEMGET(4, 18)
		|| *(WORD*)ObjectItem == ITEMGET(5, 10)
		|| *(WORD*)ObjectItem == ITEMGET(2, 13)
		|| *(WORD*)ObjectItem == ITEMGET(13, 30))
	{
		Excel = 0;
	}
	...
	*(BYTE*)(ObjectItem + 22) = *(BYTE*)(ItemAttribute + 45);	  //Item->MagicPower		
	...
	if (*(BYTE *)(ItemAttribute + 45)) // -> MagicPower
	{
		...
		*(BYTE*)(ObjectItem + 22) /= 2;
		...
		if (*(WORD*)ObjectItem < ITEMGET(2, 8) || *(WORD*)ObjectItem > ITEMGET(2, 15))
		{
	...
	if (*(BYTE*)(ItemAttribute + 39)) // -> Defense
	{
		...
		else
		{
			...
			else if (*(WORD*)ObjectItem == ITEMGET(13, 30))
			{
				*(WORD*)(ObjectItem + 18) += (min(9, Level) * 2);
			}
			else
	...
	else if (*(WORD*)(ItemAttribute + 56) && ((*(WORD*)ObjectItem >= ITEMGET(12, 0) && *(WORD*)ObjectItem <= ITEMGET(12, 7)) || *(WORD*)ObjectItem >= ITEMGET(13, 0)))
	{
	...
	if (*(WORD*)ObjectItem == ITEMGET(12, 11))
	{
		WORD Energy;
	...
	if (*(WORD*)ObjectItem == ITEMGET(13, 10))
	{
		if (Level <= 2)
	...
	if ((*(WORD*)ObjectItem >= ITEMGET(7, 29) && *(WORD*)ObjectItem <= ITEMGET(7, 33)) ||
		(*(WORD*)ObjectItem >= ITEMGET(8, 29) && *(WORD*)ObjectItem <= ITEMGET(8, 33)) ||
		(*(WORD*)ObjectItem >= ITEMGET(9, 29) && *(WORD*)ObjectItem <= ITEMGET(9, 33)) ||
		(*(WORD*)ObjectItem >= ITEMGET(10, 29) && *(WORD*)ObjectItem <= ITEMGET(10, 33)) ||
		(*(WORD*)ObjectItem >= ITEMGET(11, 29) && *(WORD*)ObjectItem <= ITEMGET(11, 33)) ||
		*(WORD*)ObjectItem == ITEMGET(0, 22) ||
		*(WORD*)ObjectItem == ITEMGET(0, 23) ||
		*(WORD*)ObjectItem == ITEMGET(5, 12) ||
		*(WORD*)ObjectItem == ITEMGET(4, 21) ||
		*(WORD*)ObjectItem == ITEMGET(2, 14))
	{
		Excel = 0;
	}
	...
	*(BYTE*)(ObjectItem + 42) = 0; // -> Special Num
	...
	if (Attribute1 & 0x04)
	{
		if (*(WORD*)ObjectItem >= ITEMGET(0, 0) && *(WORD*)ObjectItem < 6144)
		{
			if (*(WORD*)ObjectItem != ITEMGET(4, 7) && *(WORD*)ObjectItem != ITEMGET(4, 15))
			{
		...
		if (*(WORD*)ObjectItem >= ITEMGET(12, 0) && *(WORD*)ObjectItem <= ITEMGET(12, 6))
		{
			*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 43) = 84; // -> Luck
			++*(BYTE*)(ObjectItem + 42);
		}

		if (*(WORD*)ObjectItem >= ITEMGET(13, 30))
		{
			*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 43) = 84; // -> Luck
			++*(BYTE*)(ObjectItem + 42);
		}
	...
	if (Option3)
	{
		if (*(WORD*)ObjectItem == ITEMGET(13, 3))
		{
			if (Option3 & 0x01)
			{
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = 5;
		...
		{
			if (*(WORD*)ObjectItem >= ITEMGET(0, 0) && *(WORD*)ObjectItem < ITEMGET(5, 0))
			{
				if (*(WORD*)ObjectItem != ITEMGET(4, 7) && *(WORD*)ObjectItem != ITEMGET(4, 15))
				{
			...
			if (*(WORD*)ObjectItem >= ITEMGET(5, 0) && *(WORD*)ObjectItem < ITEMGET(6, 0))
			{
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
			...
			if (*(WORD*)ObjectItem >= ITEMGET(6, 0) && *(WORD*)ObjectItem < ITEMGET(7, 0))
			{
			...
			if (*(WORD*)ObjectItem >= ITEMGET(7, 0) && *(WORD*)ObjectItem < ITEMGET(12, 0))
			{
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
			...
			if (*(WORD*)ObjectItem >= ITEMGET(13, 8) && *(WORD*)ObjectItem < ITEMGET(14, 0) && *(WORD*)ObjectItem != ITEMGET(13, 30))
			{
				if (*(WORD*)ObjectItem == ITEMGET(13, 24))
				{
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3;
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 43) = 175; // -> Improve Max Mana (Verificar)
					++*(BYTE*)(ObjectItem + 42);
				}
				else if (*(WORD*)ObjectItem == ITEMGET(13, 28))
				{
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3;
			...
			if (*(WORD*)ObjectItem == ITEMGET(12, 0))
			{
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3;
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 43) = 85; // -> Life Regeneration
				++*(BYTE*)(ObjectItem + 42);
			}
			else if (*(WORD*)ObjectItem == ITEMGET(12, 1))
			{
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 43) = 81; // -> Improve Magic
				++*(BYTE*)(ObjectItem + 42);
			}
			else if (*(WORD*)ObjectItem == ITEMGET(12, 2))
			{
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
				*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 43) = 80; // -> Improve Damage
				++*(BYTE*)(ObjectItem + 42);
			}
			else if (*(WORD*)ObjectItem == ITEMGET(12, 3))
			{
				if (Attribute2 & 0x20)
				{
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3;
			...
			else if (*(WORD*)ObjectItem == ITEMGET(12, 4))
			{
				if (Attribute2 & 0x20)
				{
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
			...
			else if (*(WORD*)ObjectItem == ITEMGET(12, 5))
			{
				if (Attribute2 & 0x20)
				{
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
			...
			else if (*(WORD*)ObjectItem == ITEMGET(12, 6))
			{
				if (Attribute2 & 0x20)
				{
					*(BYTE*)(*(BYTE*)(ObjectItem + 42) + ObjectItem + 51) = Option3 * 4;
	...
	if (*(WORD*)ObjectItem == ITEMGET(13, 4))
	{
		pPetItemConvert(ObjectItem);
	}

	if ((*(WORD*)ObjectItem >= ITEMGET(6, 0) && *(WORD*)ObjectItem < ITEMGET(12, 0)) || (*(WORD*)ObjectItem >= ITEMGET(13, 8) && *(WORD*)ObjectItem <= ITEMGET(13, 9))
		|| (*(WORD*)ObjectItem >= ITEMGET(13, 21) && *(WORD*)ObjectItem <= ITEMGET(13, 24)))
	{
		if (Attribute2 & 0x20)
		{
	...
	if ((*(WORD*)ObjectItem >= ITEMGET(0, 0) && *(WORD*)ObjectItem < ITEMGET(6, 0)) ||
		(*(WORD*)ObjectItem >= ITEMGET(13, 12) && *(WORD*)ObjectItem <= ITEMGET(13, 13))
		|| (*(WORD*)ObjectItem >= ITEMGET(13, 25) && *(WORD*)ObjectItem <= ITEMGET(13, 28)))
	{
		if (Attribute2 & 0x20)
		{
		...
		if ((*(WORD*)ObjectItem >= ITEMGET(5, 0) && *(WORD*)ObjectItem < ITEMGET(6, 0)) || (*(WORD*)ObjectItem == ITEMGET(13, 12))
			|| (*(WORD*)ObjectItem == ITEMGET(13, 25) || *(WORD*)ObjectItem == ITEMGET(13, 27)))
		{
			if (Attribute2 & 0x10)
			{
	...
	if (*(WORD*)ObjectItem == ITEMGET(13, 20))
	{
		switch (Level)
		{
		case 0:
	...
	if (*(WORD*)ObjectItem >= ITEMGET(4, 0) && *(WORD*)ObjectItem < ITEMGET(4, 8))
	{
		*(BYTE*)(ObjectItem + 8) = 1; // EQUIPMENT_WEAPON_LEFT
	}
	else if (*(WORD*)ObjectItem >= ITEMGET(0, 0) && *(WORD*)ObjectItem < ITEMGET(6, 0))
	{
		*(BYTE*)(ObjectItem + 8) = 0; // EQUIPMENT_WEAPON_RIGHT
	}
	else if (*(WORD*)ObjectItem >= ITEMGET(6, 0) && *(WORD*)ObjectItem < ITEMGET(7, 0))
	{
		*(BYTE*)(ObjectItem + 8) = 1; // EQUIPMENT_WEAPON_LEFT
	}
	else if (*(WORD*)ObjectItem >= ITEMGET(7, 0) && *(WORD*)ObjectItem < ITEMGET(8, 0))
	{
		*(BYTE*)(ObjectItem + 8) = 2; // EQUIPMENT_HELM
	}
	else if (*(WORD*)ObjectItem >= ITEMGET(8, 0) && *(WORD*)ObjectItem < ITEMGET(9, 0))
		*(BYTE*)(ObjectItem + 8) = 3; // EQUIPMENT_ARMOR
	else if (*(WORD*)ObjectItem >= ITEMGET(9, 0) && *(WORD*)ObjectItem < ITEMGET(10, 0))
		*(BYTE*)(ObjectItem + 8) = 4; // EQUIPMENT_PANTS
	else if (*(WORD*)ObjectItem >= ITEMGET(10, 0) && *(WORD*)ObjectItem < ITEMGET(11, 0))
		*(BYTE*)(ObjectItem + 8) = 5; // EQUIPMENT_GLOVES
	else if (*(WORD*)ObjectItem >= ITEMGET(11, 0) && *(WORD*)ObjectItem < ITEMGET(12, 0))
		*(BYTE*)(ObjectItem + 8) = 6; // EQUIPMENT_BOOTS
	else if (*(WORD*)ObjectItem >= ITEMGET(12, 0) && *(WORD*)ObjectItem < ITEMGET(12, 7))
		*(BYTE*)(ObjectItem + 8) = 7; // EQUIPMENT_WING
	else if (*(WORD*)ObjectItem == ITEMGET(13, 5))
		*(BYTE*)(ObjectItem + 8) = 1; // EQUIPMENT_WEAPON_LEFT
	else if (*(WORD*)ObjectItem >= ITEMGET(13, 0) && *(WORD*)ObjectItem < ITEMGET(13, 8))
		*(BYTE*)(ObjectItem + 8) = 8; // EQUIPMENT_HELPER
	else if ((*(WORD*)ObjectItem >= ITEMGET(13, 8) && *(WORD*)ObjectItem < ITEMGET(13, 12)) || (*(WORD*)ObjectItem == ITEMGET(13, 20) && Level == 0) || (*(WORD*)ObjectItem == ITEMGET(13, 20) && Level == 3))
		*(BYTE*)(ObjectItem + 8) = 10; // EQUIPMENT_RING_RIGHT
	else if (*(WORD*)ObjectItem >= ITEMGET(13, 21) && *(WORD*)ObjectItem <= ITEMGET(13, 24))
		*(BYTE*)(ObjectItem + 8) = 10; // EQUIPMENT_RING_RIGHT
	else if (*(WORD*)ObjectItem >= ITEMGET(13, 25) && *(WORD*)ObjectItem <= ITEMGET(13, 28))
		*(BYTE*)(ObjectItem + 8) = 9; // EQUIPMENT_AMULET
	else if (*(WORD*)ObjectItem >= ITEMGET(13, 12) && *(WORD*)ObjectItem < ITEMGET(14, 0))
		*(BYTE*)(ObjectItem + 8) = 9; // EQUIPMENT_AMULET
	else
		*(BYTE*)(ObjectItem + 8) = -1;
}