...
enum eAuthServerType
{
	...
	// Season 1 ( Original S6 )
	AUTH_SERVER_TYPE_S1_CONNECT_SERVER = 1,
	AUTH_SERVER_TYPE_S1_JOIN_SERVER = 2,
	AUTH_SERVER_TYPE_S1_DATA_SERVER = 3,
	AUTH_SERVER_TYPE_S1_GAME_SERVER = 4,
	// Season 3 ( Original S8 )
	AUTH_SERVER_TYPE_S3_CONNECT_SERVER = 5,
	AUTH_SERVER_TYPE_S3_JOIN_SERVER = 6,
	AUTH_SERVER_TYPE_S3_DATA_SERVER = 7,
	AUTH_SERVER_TYPE_S3_GAME_SERVER = 8,
	// Season 6 ( Original S4 )
	AUTH_SERVER_TYPE_S6_CONNECT_SERVER = 9,
	AUTH_SERVER_TYPE_S6_JOIN_SERVER = 10,
	AUTH_SERVER_TYPE_S6_DATA_SERVER = 11,
	AUTH_SERVER_TYPE_S6_GAME_SERVER = 12,
	// Season 4  ( Original S2 )
	AUTH_SERVER_TYPE_S4_CONNECT_SERVER = 13,
	AUTH_SERVER_TYPE_S4_JOIN_SERVER = 14,
	AUTH_SERVER_TYPE_S4_DATA_SERVER = 15,
	AUTH_SERVER_TYPE_S4_GAME_SERVER = 16,
};
...
public:
	...
	void __thiscall ReleaseBlock(DWORD size);
...
static BYTE gProtectString3[15] = { 0x81,0x84,0x89,0x9E,0x85,0x86,0x9E,0x81,0x82,0x85,0x9E,0x81,0x80,0x82,0xB0 }; //149.56.125.102
