...
void CItem::Convert(int type, BYTE Option1, BYTE Option2, BYTE Option3, BYTE Attribute2, BYTE SetOption, BYTE ItemEffectEx, BYTE DbVersion)
{
	...
	if (((_type >= ITEMGET(12, 0)) && (_type <= ITEMGET(12, 6))) || (_type == ITEMGET(12, 5)) || NEWWINGS(_type))
	{
		Attribute2 = 0;
	}
	...
	{
		this->m_RequireLeaderShip = this->m_PetItem_Level * 2 + 218;
	}
	else
	{
		this->m_RequireLeaderShip = 0;
	...
	if (Option3 != 0)
	{
		...
		if (_type == ITEMGET(12, 104) || _type == ITEMGET(12, 105))
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 85;
		...
		if (_type == ITEMGET(12, 112) || _type == ITEMGET(12, 113))
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 85;
		...
		if ((_type >= ITEMGET(12, 115)) && (_type <= ITEMGET(12, 200)))
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 85;
...
void CItem::Value()
{
		...
		this->m_Type != ITEMGET(14, 50))
	{
		...
		if (this->m_SellMoney > lc16)
		{
			this->m_SellMoney -= lc16;
		}
		else
		{
			lc16 -= this->m_SellMoney;
		}
	}
