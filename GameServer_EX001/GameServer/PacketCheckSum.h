...
#define MAX_PACKET_CHECKSUM_Func_INDEX	22
#define MAX_CHECKSUM_TABLE_AVG	100

struct PAKETCHECKSUM
{
	DWORD Check[MAX_PACKET_CHECKSUM_Func_INDEX];	// 0
};
...
private:
	...
	int m_ChecksumTableClearState[MAX_PACKET_CHECKSUM_Func_INDEX];	// 9EFC8
	int m_ChecksumTableAVGCount[MAX_PACKET_CHECKSUM_Func_INDEX];	// 9F020
	DWORD m_ChecksumTableAVG[MAX_PACKET_CHECKSUM_Func_INDEX][MAX_CHECKSUM_TABLE_AVG];	// 9F078
	DWORD m_ChecksumTable[MAX_PACKET_CHECKSUM_Func_INDEX];	// A12D8
};
