...
public:
	...
	void SetCrownUserIndex(int iIndex) { this->m_iCastleCrownAccessUser = iIndex; } //HermeX Fix
	...
	/*this+0xC7*/ char m_szCastleOwnerGuild[16];
	...
	/*this+0xF0*/ std::vector<_CS_SCHEDULE_DATA> m_vtScheduleData;
	/*this+0x100*/ CRITICAL_SECTION m_critScheduleData;
	/*this+0x118*/ std::vector<_CS_NPC_DATA> m_vtNpcData;
	/*this+0x128*/ CRITICAL_SECTION m_critNpcData;
	/*this+0x140*/ int m_bDbNpcCreated;
	/*this+0x144*/ std::map<string, _CS_TOTAL_GUILD_DATA> m_mapCsBasicGuildInfo;
	/*this+0x154*/ CRITICAL_SECTION m_critCsBasicGuildInfo;
	/*this+0x16C*/ std::map<std::string, _CS_TOTAL_GUILD_DATA> m_mapCsTotalGuildInfo;
	...
	/*this+0x19C*/ std::map<int, _CS_MINIMAP_DATA > m_mapMiniMapData;
	/*this+0x1AC*/ CRITICAL_SECTION m_critCsMiniMap;
	/*this+0x1C4*/ std::vector<int> m_vtMiniMapReqUser;
	...
	/*this+0x1F4*/ char m_szMiddleWinnerGuild[16];
};
